...
func printSSHAgentHelp(cli labcli.CLI) {
	...
	if runtime.GOOS == "windows" {
		cli.PrintAux("    ssh-add %s  # add the key (ensure the OpenSSH Authentication Agent service is running)\n", filepath.Join(cli.Config().SSHIdentityFile))
		return
	}
